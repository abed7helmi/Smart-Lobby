...
public class FloorSelection {
	...
	public static void floorSelection(String reservation_id) {
		try {
		JLabel title = new JLabel("Sélectionnez le batiment et l'étage à configurer:");
		...
		for(int i=0;i<floorList.length;i++) {
			floorList[i]="Batiment "+floors.get(""+i).get("building_name")+" étage "+floors.get(""+i).get("floor_number");
		}
